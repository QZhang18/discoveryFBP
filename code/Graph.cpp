#include"Graph.h"
void Graph5::addVertex(int eLabel) {
	vector<int> temp;
...
void Graph5::addEdge(int from, int to, int eLabel) {
...
bool Graph5::hasEdge(int fromLabel, int eLabel, int toLabel) {
	for (size_t i = 0; i < vertexLabel.size(); i++) {
...
void Graph5::removeEdge(int fromLabel, int eLabel, int toLabel) {
	for (size_t i = 0; i < vertexLabel.size(); i++) {
